...
const DEFAULT_IDENTIFIERS = [
  ...
  { standard: 'SMART', flowStep: 'fhir_request',              description: 'FHIR Resource 存取請求 (Step 300)',                                       method: '*',    urlContains: '/fhir|fhirsrv',                    bodyGrantType: null,                 priority: 5 },
  ...
  { standard: 'IUA', flowStep: 'fhir_request',              description: 'IUA Step 3 — ITI-72 Incorporate Access Token',                    method: '*',    urlContains: '/fhir|fhirsrv',                  bodyGrantType: null,                 priority: 5 },
];
...
const DEFAULT_FIELDS = [
  ...
  { standard: 'IUA', flowStep: 'token_request_client_cred', fieldName: 'client_id',            fieldLocation: 'body_params', fieldType: 'conditional', pattern: null,                    sortOrder: 4 },
  { standard: 'IUA', flowStep: 'token_request_client_cred', fieldName: 'client_secret',        fieldLocation: 'body_params', fieldType: 'conditional', pattern: null,                    sortOrder: 5 },
